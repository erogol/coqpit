...
class NestedConfig(Coqpit):
    ...
    union_var: Union[List[SimpleConfig], SimpleConfig] = field(
        default_factory=lambda: [SimpleConfig(), SimpleConfig()]
    )
    ...
    def check_values(
        ...
        check_argument(
            "val_e", c, restricted=True, min_val=128, max_val=4058, allow_none=True
        )
...
def test_nested():
    ...
    config2 = NestedConfig(
        val_d=None, val_e=500, val_f=None, sc_list=None, sc=None, union_var=None
    )
